...
Revise the running draft answer to obey one rule: confirm the whole answer is fully understood.

## Inputs

| Source | File/Location | Section/Scope | Why |
|--------|--------------|---------------|-----|
| Previous stage | `../13-no-intuition/output/13-draft.md` | Full file | The running draft answer to revise |
...
3. Revise the draft to confirm the whole answer is fully understood. Change nothing that already obeys the rule.
4. Do not weaken any earlier rule.
5. Save to `output/14-draft.md`. IMMEDIATELY continue to `15-never-lie`.
...
|----------|----------|--------|
| Revised draft | `output/14-draft.md` | Plain-text answer obeying this rule and all earlier ones |
