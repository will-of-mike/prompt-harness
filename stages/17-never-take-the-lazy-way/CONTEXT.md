...
Revise the running draft answer to obey one rule: redo anything that was done the lazy way.

## Inputs

| Source | File/Location | Section/Scope | Why |
|--------|--------------|---------------|-----|
| Previous stage | `../16-never-trick/output/16-draft.md` | Full file | The running draft answer to revise |
...
3. Revise the draft to redo anything that was done the lazy way. Change nothing that already obeys the rule.
4. Do not weaken any earlier rule.
5. Save to `output/17-draft.md`. IMMEDIATELY continue to `18-no-sayings`.
...
|----------|----------|--------|
| Revised draft | `output/17-draft.md` | Plain-text answer obeying this rule and all earlier ones |
