...
Revise the running draft answer to obey one rule: run the reliability self-check.
...
3. Revise the draft to run the reliability self-check. Change nothing that already obeys the rule.
4. Do not weaken any earlier rule.
5. Save to `output/24-draft.md`. IMMEDIATELY continue to `25-handle-what-goes-wrong`.
...
|----------|----------|--------|
| Revised draft | `output/24-draft.md` | Plain-text answer obeying this rule and all earlier ones |
