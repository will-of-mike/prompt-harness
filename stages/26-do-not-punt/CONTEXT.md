...
Revise the running draft answer to obey one rule: produce the whole answer and never punt.

## Inputs

| Source | File/Location | Section/Scope | Why |
|--------|--------------|---------------|-----|
| Previous stage | `../25-handle-what-goes-wrong/output/25-draft.md` | Full file | The running draft answer to revise |
...
3. Revise the draft to produce the whole answer and never punt. Change nothing that already obeys the rule.
4. Do not weaken any earlier rule.
5. Save to `output/26-draft.md`. IMMEDIATELY continue to `99-put-it-all-together`.
...
|----------|----------|--------|
| Revised draft | `output/26-draft.md` | Plain-text answer obeying this rule and all earlier ones |
